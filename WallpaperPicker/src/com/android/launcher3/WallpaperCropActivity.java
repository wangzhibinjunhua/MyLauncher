...
public class WallpaperCropActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!enableRotation()) {
            setRequestedOrientation(Configuration.ORIENTATION_LANDSCAPE);//wbin modify  ORIENTATION_PORTRAIT
        }
        init();
    }
    ...
    static protected Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
        if (sDefaultWallpaperSize == null) {
			...
			windowManager.getDefaultDisplay().getRealSize(realSize);
            if (/*isScreenLarge(res)*/false) {//wbin modify
    ...
    protected void cropImageAndSetWallpaper(
        ...
        Point outSize = getDefaultWallpaperSize(getResources(),
                getWindowManager());
		Log.e(LOGTAG, "cropImageAndSetWallpaper rotation "+rotation+"inSize x "+inSize.x+"inSize y "+inSize.y+"outSize x "+outSize.x+"outSize y"+outSize.y);
